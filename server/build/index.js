...
var tailwind_default = "/build/_assets/tailwind-LYU6AXOK.css";

// app/styles/global.css
var global_default = "/build/_assets/global-TSESKBFT.css";
...
// app/const.ts
var toolname = "sentence segmentation", DIVIDER = `
`, NEW_LINER = "\u21A9\uFE0F";
...
// app/tiptapProps/extension/divider.ts
var import_core2 = require("@tiptap/core"), import_prosemirror_state = require("prosemirror-state");

// app/lib/utils.ts
function replaceNewlinewithTag(text, length) {
  let tag = `<Divider class="d-${length} Divider">${NEW_LINER}</Divider><br/>`;
  return text.replace(new RegExp(DIVIDER, "g"), tag);
}
function removeDivider(text) {
  return text.replace(new RegExp(DIVIDER, "g"), "");
}

// app/lib/textSegmentor.ts
...
function segmentTibetanText(text) {
  let breaks = "\u0F04\u0F05\u0F0D", spaces = " \u0F0B", newline = `
`, segments = [], currentSegment = "", currentStart = 0, inBreak = !1, inSpace = !1, count = 0;
  function processCurrentSegment() {
    if (count > 0) {
      let newSegment = makeSegment(currentSegment, currentStart);
      segments.push(newSegment), currentSegment = "", inBreak = !1, inSpace = !1;
    }
  }
  for (let char of text)
    char === newline ? (processCurrentSegment(), currentSegment = char, currentStart = count + 1) : breaks.includes(char) ? inBreak ? currentSegment += char : (processCurrentSegment(), inBreak = !0, currentSegment = char, currentStart = count) : spaces.includes(char) ? inSpace ? currentSegment += char : (processCurrentSegment(), inSpace = !0, currentSegment = char, currentStart = count) : inSpace || inBreak ? (processCurrentSegment(), currentSegment = char, currentStart = count) : currentSegment += char, count++;
  if (currentSegment) {
    let newSegment = makeSegment(currentSegment, currentStart);
...
function insertHTMLonText(content) {
  if (!content)
    return "";
  let regex = new RegExp(NEW_LINER.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")), data = splitText(content), sentenceCount = 1, charCount = 0, textHTML = `<Sn class='sen st-${sentenceCount}'>`;
  return data.forEach(({ char, start }) => {
    let cleanedWord = char.replace(regex, "");
    cleanedWord.includes(" ") ? (textHTML += `<Ch class='seg s-${charCount}'>${cleanedWord}</Ch>`, sentenceCount += 1, textHTML += `</Sn><Sn class='sen st-${sentenceCount}'>`, charCount += cleanedWord.length) : cleanedWord === DIVIDER ? (textHTML += "</Sn>", textHTML += replaceNewlinewithTag(cleanedWord, charCount), sentenceCount += 1, charCount += 3, textHTML += `<Sn class='sen st-${sentenceCount}'>`) : (textHTML += `<Ch class='seg s-${charCount}'>${cleanedWord}</Ch>`, charCount += cleanedWord.length);
  }), textHTML += "</Sn>", textHTML;
}
function splitText(text) {
  let data = segmentTibetanText(text).map((item) => item.text), finalItem = [];
...
`), finalItem.push(temp[1]);
      ...
      if (data[i + 2] === "\u0F0D" && data[i + 3] === " " && data[i + 4] === "\u0F0D") {
        let temp = data[i] + data[i + 1] + data[i + 2] + data[i + 3] + data[i + 4];
        finalItem.push(temp), i = i + 4;
      } else if (data[i + 2] === "\u0F0D" && data[i + 3] === " " && data[i + 4] !== "\u0F0D") {
        let temp = data[i] + data[i + 1] + data[i + 2] + data[i + 3];
        finalItem.push(temp), i = i + 3;
      } else
        data[i + 2] === " " ? (finalItem.push(data[i] + "\u0F0B "), i = i + 2) : (finalItem.push(data[i] + "\u0F0B"), i++);
    else if (data[i + 1] === "\u0F0B ")
      if (data[i + 2] === "\u0F0D" && data[i + 3] === " " && data[i + 4] === "\u0F0D") {
        let temp = data[i] + data[i + 1] + data[i + 2] + data[i + 3] + data[i + 4];
        finalItem.push(temp), i = i + 4;
        ...
        finalItem.push(data[i] + data[i + 1]), i++;
    else if (data[i + 1] === "\u0F0D") {
...
`;
      ...
      if (data[i + 2] === "\u0F0D") {
        ...
        finalItem.push(data[i] + data[i + 1]), i++;
    else if (data[i].endsWith("\u0F0D") && data[i + 1] === " " && data[i + 2] === "\u0F0D") {
      let temp = data[i] + data[i + 1] + data[i + 2];
      finalItem.push(temp), i = i + 2;
    } else if (data[i].endsWith("\u0F0D") && data[i + 1] === " " && data[i + 2] !== "\u0F0D") {
      let temp = data[i] + data[i + 1];
      finalItem.push(temp), i = i + 1;
    } else
      finalItem.push(data[i]);
  let count = 0;
  return finalItem.map((item) => {
    let data2 = { char: item, start: count };
    return count += item.length, data2;
  });
}
var insertHtmlOnText_default = insertHTMLonText;

// app/tiptapProps/extension/divider.ts
var Divider = (setter) => import_core2.Mark.create({
  name: "Divider",
  addOptions() {
    return {
      multicolor: !1,
        ...
        props: {
          handleClick: (view, pos, event) => {
            ...
            if (pos < 0 || pos > doc.content.size)
              return !1;
            let range = (0, import_core2.getMarkRange)(
              doc.resolve(pos),
            ...
            return removeDivider(modifiedContent) === removeDivider(content) && (this.editor.commands.setContent(newText), this.editor.commands.unsetSpace()), !0;
          }
        }
      })
    ];
...
// app/tiptapProps/extension/sentence.ts
var import_core3 = require("@tiptap/core"), Sentence = (charClick) => import_core3.Mark.create({
  name: "Sn",
  addOptions() {
    return {
      multicolor: !1,
...
// app/tiptapProps/useEditorTiptap.tsx
function useEditorTiptap(text) {
  let setter = () => {
  }, charClick = () => {
  }, insertHTML = insertHtmlOnText_default(text);
...
var import_react23 = require("@remix-run/react"), import_jsx_dev_runtime19 = require("react/jsx-dev-runtime");
function AssignedBatchList({ user }) {
  var _a;
  let { groups } = (0, import_react23.useLoaderData)(), userfetcher = (0, import_react23.useFetcher)(), removeBatch = (e) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)("div", { className: "mt-2 flex gap-2", children: [
    reviewedBatch.length > 0 && /* @__PURE__ */ (0, import_jsx_dev_runtime19.jsxDEV)(
      "div",
      {
        title,
...
var AboutUser = ({
  ...
  let { users } = (0, import_react24.useLoaderData)(), annotator = users.find((user2) => (user2 == null ? void 0 : user2.username) === selectedUser), reviewed_count = annotator == null ? void 0 : annotator.text.filter((item) => item.reviewed).length, approved_count = annotator == null ? void 0 : annotator.text.length, url = `/admin/user/review/${selectedUser}?session=` + user.username, isAdmin = user.role === "ADMIN";
  return selectedUser === "" ? null : /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("div", { className: "sticky top-[80px]  rounded-sm border border-stroke bg-white px-5 pt-6 pb-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-10 ", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(Info, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(Title, { children: [
        "Assigned Batch:",
        /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)("div", { title: "reviewed/total", children: [
          reviewed_count,
          "/",
          approved_count
        ] }, void 0, !0, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime20.jsxDEV)(AssignedBatchList_default, { user: annotator }, void 0, !1, {
        fileName: "app/components/admin/AboutUser.tsx",
        lineNumber: 75,
        columnNumber: 9
      }, this)
...
var import_react25 = require("@remix-run/react"), import_react26 = require("react"), import_jsx_dev_runtime21 = require("react/jsx-dev-runtime"), UserListCard = ({
  setSelectedUser,
  selectedUser,
  user
}) => {
  let { users } = (0, import_react25.useLoaderData)(), reviewers = users.filter((user2) => user2.role === "REVIEWER"), isAdmin = user.role === "ADMIN", [selectedReviewer, setSelectedReviewer] = (0, import_react26.useState)("All"), [search, setSearch] = (0, import_react26.useState)("");
  ...
  return selectedReviewer !== "All" && (list = list.filter(
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("h4", { className: "mb-6 pl-2 px-7.5 text-xl font-semibold text-black dark:text-white", children: "Annotators" }, void 0, !1, {
...
function EachUser({ user, setSelectedUser, selectedUser }) {
  let { groups } = (0, import_react25.useLoaderData)(), handleSelection = (value) => {
    console.log(...oo_oo("17534074_0", "hi from userlistcard")), setSelectedUser(value);
  }, currentBatch = user.assigned_batch.filter(
    (item) => {
      var _a, _b;
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("div", { className: "flex flex-1 items-center justify-between px-2", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime21.jsxDEV)("h5", { className: "font-medium text-black dark:text-white", children: user.nickname }, void 0, !1, {
            fileName: "app/components/admin/UserListCard.tsx",
            lineNumber: 102,
            columnNumber: 11
          }, this),
...
async function uploadData({ name, data }) {
  try {
    if (await db.text.findFirst({
      ...
      return console.log(...oo_oo2("734339480_0", "Record already exists")), { error: "Record already exists" };
    let UploadData = data == null ? void 0 : data.map((item) => ({
      version: name,
      original_text: item.original_text,
      batch: item.batch
    }));
    return await db.text.createMany({
      data: UploadData
    });
  } catch (e) {
...
var action3 = async ({ request }) => {
  ...
  if (request.method === "PATCH") {
    ...
    if (action5 === "change_category") {
      ...
      return text = await changeCategory(version, category), text;
    }
  }
  if (request.method === "DELETE") {
...
var loader6 = async ({ request }) => ({ users: await getUsers() }), action4 = async ({ request }) => {
...
var import_node6 = require("@remix-run/node"), import_react32 = require("react"), import_react33 = require("@remix-run/react");
...
function useOnlineCount() {
  let [onlineCount, setOnlineCount] = (0, import_react29.useState)(0), socket = useSocket();
...
function Sidebar({ user, text }) {
  var _a, _b, _c, _d, _e;
  let onlineCount = useOnlineCount(), [openMenu, setOpenMenu] = (0, import_react31.useState)(!1);
...
function Index2() {
  var _a, _b, _c;
  let fetcher = (0, import_react33.useFetcher)(), data = (0, import_react33.useLoaderData)(), text = ((_a = data == null ? void 0 : data.text) == null ? void 0 : _a.original_text.trim()) || "", user = data.user, editor = useEditorTiptap(text), socket = useSocket(), revalidate = (0, import_react33.useRevalidator)();
...
var import_react34 = require("react"), import_jsx_dev_runtime25 = require("react/jsx-dev-runtime"), DropdownUser = ({ user }) => {
...
var import_jsx_dev_runtime27 = require("react/jsx-dev-runtime"), Header = (props) => {
  let { progress, user } = (0, import_react35.useLoaderData)();
...
function Sidebar2({ sidebarOpen, setSidebarOpen }) {
  let sidebar = (0, import_react36.useRef)(null), trigger = (0, import_react36.useRef)(null), { pathname } = (0, import_react37.useLocation)(), { user } = (0, import_react37.useLoaderData)(), url = "/?session=" + (user == null ? void 0 : user.username);
    ...
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime28.jsxDEV)("div", { className: "flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime28.jsxDEV)(import_react37.NavLink, { to: url, children: /* @__PURE__ */ (0, import_jsx_dev_runtime28.jsxDEV)("h3", { className: "mb-2 text-2xl pt-4 font-semibold text-bodydark2 capitalize", children: toolname }, void 0, !1, {
...
var import_jsx_dev_runtime29 = require("react/jsx-dev-runtime"), loader9 = async ({ request }) => {
  let session = new URL(request.url).searchParams.get("session");
  if (!session)
  ...
  let [sidebarOpen, setSidebarOpen] = (0, import_react38.useState)(!1), { pathname } = (0, import_react39.useLocation)(), { user } = (0, import_react39.useLoaderData)();
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime29.jsxDEV)("div", { className: "relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime29.jsxDEV)("main", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime29.jsxDEV)(
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_dev_runtime29.jsxDEV)(import_react39.Outlet, { context: user }, void 0, !1, {
            fileName: "app/routes/admin.tsx",
            lineNumber: 37,
            columnNumber: 15
          }, this)
...
var import_jsx_dev_runtime30 = require("react/jsx-dev-runtime"), loader10 = () => null;
function error() {
...
function Sidebar3({ user, text, setHistory }) {
  var _a, _b, _c, _d;
  let [openMenu, setOpenMenu] = (0, import_react40.useState)(!1);
...
// app/routes/demo.tsx
var import_Editor3 = __toESM(require_Editor()), import_react43 = require("@remix-run/react");

// app/components/hooks/useModal.tsx
var import_react41 = require("react"), import_jsx_dev_runtime32 = require("react/jsx-dev-runtime");
function useModal() {
  let [isOpen, setIsOpen] = (0, import_react41.useState)(!1), openModal = () => {
    setIsOpen(!0);
  };
  return { Toggle_Modal: ({ children, ...props }) => /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("button", { onClick: openModal, ...props, children }, void 0, !1, {
    fileName: "app/components/hooks/useModal.tsx",
    lineNumber: 10,
    columnNumber: 5
  }, this), Modal: ({ children }) => /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(import_jsx_dev_runtime32.Fragment, { children: isOpen && /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)(
    "dialog",
    {
      open: isOpen,
      ...
      onClose: () => setIsOpen(!1),
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "modal-box w-11/12 max-w-5xl", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("div", { className: "modal-backdrop backdrop-blur-sm", children: /* @__PURE__ */ (0, import_jsx_dev_runtime32.jsxDEV)("button", { type: "button", onClick: () => setIsOpen(!1), children: "close" }, void 0, !1, {
          fileName: "app/components/hooks/useModal.tsx",
          lineNumber: 34,
          columnNumber: 13
        }, this) }, void 0, !1, {
...
function DemoPage() {
  let { text } = (0, import_react43.useLoaderData)(), [text_Array, setTextArray] = (0, import_react42.useState)(text), [user, setUser] = (0, import_react42.useState)({
    username: "demo",
    role: "USER",
    text: [],
    rejected_list: [],
    ignored_list: []
  }), [history, setHistory] = (0, import_react42.useState)(null), content = text_Array.find(
  ...
  let original_text = content.content || (content == null ? void 0 : content.original_text.trim()), insertHTML = insertHtmlOnText_default(original_text), editor = useEditorTiptap(insertHTML), saveText2 = () => {
...
var assets_manifest_default = { entry: { module: "/build/entry.client-G5CPCOLG.js", imports: ["/build/_shared/chunk-ZWGWGGVF.js", "/build/_shared/chunk-GIAAE3CH.js", "/build/_shared/chunk-YRELA4ON.js", "/build/_shared/chunk-NMZL6IDN.js", "/build/_shared/chunk-7NZECILU.js", "/build/_shared/chunk-UWV35TSL.js", "/build/_shared/chunk-BOXFZXVX.js", "/build/_shared/chunk-PNG5AS42.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-B5VYR4K2.js", imports: ["/build/_shared/chunk-M2VESD7N.js"], hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !0 }, "routes/_index": { id: "routes/_index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/_index-WMBMXN33.js", imports: ["/build/_shared/chunk-6JTLGLZV.js", "/build/_shared/chunk-4XH2CW6P.js", "/build/_shared/chunk-6RVWVBPN.js", "/build/_shared/chunk-GQDO55IS.js", "/build/_shared/chunk-G7CHZRZX.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/admin": { id: "routes/admin", parentId: "root", path: "admin", index: void 0, caseSensitive: void 0, module: "/build/routes/admin-RFTEWPYJ.js", imports: ["/build/_shared/chunk-6RVWVBPN.js", "/build/_shared/chunk-F2P733AV.js", "/build/_shared/chunk-FXCVAPJI.js", "/build/_shared/chunk-GQDO55IS.js", "/build/_shared/chunk-QX4QACTM.js", "/build/_shared/chunk-G7CHZRZX.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/admin.metabase": { id: "routes/admin.metabase", parentId: "routes/admin", path: "metabase", index: void 0, caseSensitive: void 0, module: "/build/routes/admin.metabase-XWBXGPOY.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/admin.text": { id: "routes/admin.text", parentId: "routes/admin", path: "text", index: void 0, caseSensitive: void 0, module: "/build/routes/admin.text-MXSGH7W5.js", imports: ["/build/_shared/chunk-TQEC4IOH.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/admin.user": { id: "routes/admin.user", parentId: "routes/admin", path: "user", index: void 0, caseSensitive: void 0, module: "/build/routes/admin.user-WUA6GFWI.js", imports: ["/build/_shared/chunk-M2VESD7N.js", "/build/_shared/chunk-TQEC4IOH.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/admin_.user.review.$slug": { id: "routes/admin_.user.review.$slug", parentId: "root", path: "admin/user/review/:slug", index: void 0, caseSensitive: void 0, module: "/build/routes/admin_.user.review.$slug-O72TAHCK.js", imports: ["/build/_shared/chunk-6JTLGLZV.js", "/build/_shared/chunk-JQUBYINZ.js", "/build/_shared/chunk-4XH2CW6P.js", "/build/_shared/chunk-6RVWVBPN.js", "/build/_shared/chunk-GQDO55IS.js", "/build/_shared/chunk-G7CHZRZX.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/api.text": { id: "routes/api.text", parentId: "root", path: "api/text", index: void 0, caseSensitive: void 0, module: "/build/routes/api.text-A4DRPZQ7.js", imports: void 0, hasAction: !0, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/api.text.$version": { id: "routes/api.text.$version", parentId: "routes/api.text", path: ":version", index: void 0, caseSensitive: void 0, module: "/build/routes/api.text.$version-D5R6AXVU.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/api.upload": { id: "routes/api.upload", parentId: "root", path: "api/upload", index: void 0, caseSensitive: void 0, module: "/build/routes/api.upload-NKI3ERUQ.js", imports: void 0, hasAction: !0, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/api.user": { id: "routes/api.user", parentId: "root", path: "api/user", index: void 0, caseSensitive: void 0, module: "/build/routes/api.user-7BYWHH7L.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/api.user.$username": { id: "routes/api.user.$username", parentId: "routes/api.user", path: ":username", index: void 0, caseSensitive: void 0, module: "/build/routes/api.user.$username-K3HPPKXU.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/api.word": { id: "routes/api.word", parentId: "root", path: "api/word", index: void 0, caseSensitive: void 0, module: "/build/routes/api.word-JTVRFTHW.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/demo": { id: "routes/demo", parentId: "root", path: "demo", index: void 0, caseSensitive: void 0, module: "/build/routes/demo-ED52X6FF.js", imports: ["/build/_shared/chunk-JQUBYINZ.js", "/build/_shared/chunk-4XH2CW6P.js", "/build/_shared/chunk-6RVWVBPN.js", "/build/_shared/chunk-GQDO55IS.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/error": { id: "routes/error", parentId: "root", path: "error", index: void 0, caseSensitive: void 0, module: "/build/routes/error-L2HQWHB7.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, version: "005e0245", hmr: { runtime: "/build/_shared\\chunk-7NZECILU.js", timestamp: 1695027058036 }, url: "/build/manifest-005E0245.js" };
